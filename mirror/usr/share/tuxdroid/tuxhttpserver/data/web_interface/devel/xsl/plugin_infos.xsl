...
<html>
    <head>
        ...
        <script src="/data/web_interface/devel/js/plugin.js" type="text/javascript"/>
    ...
    <body bgcolor="#090909" onload="javascript:fillHelpBox();">
        <xsl:for-each select="root/data">
            ...
            <div style="position:absolute;
                        left:0px;
                        top:0px;">
                <!-- SHOW PLUGIN TOOL BOX : MAKE A GADGET -->
                <xsl:call-template name="showPluginToolBoxMakeGadget">
                    <xsl:with-param name="title" select="'Plugin tool box'"/>
                ...
                <xsl:call-template name="showCommands">
                    ...
                    <xsl:with-param name="commandType" select="'plugin'"/>
                </xsl:call-template>
                <!-- SHOW MISC PLUGIN -->
                <xsl:call-template name="showMiscPlugin">
